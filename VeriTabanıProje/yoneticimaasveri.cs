...
namespace VeriTabanıProje
{
    public partial class yoneticimaasveri : Form
    {
        ...
        private void yoneticimaasveri_MouseDown(object sender, MouseEventArgs e)
        {
            mouseDown = true;
            lastLocation = e.Location;
        }

        private void yoneticimaasveri_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            {
        ...
        private void yoneticimaasveri_MouseUp(object sender, MouseEventArgs e)
        {
            mouseDown = false;
        }
