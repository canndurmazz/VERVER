...
namespace VeriTabanıProje
{
    public partial class yoneticimaaszam : Form
    {
        ...
        private void yoneticimaaszam_MouseDown(object sender, MouseEventArgs e)
        {
            mouseDown = true;
            lastLocation = e.Location;
        }

        private void yoneticimaaszam_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            {
        ...
        private void yoneticimaaszam_MouseUp(object sender, MouseEventArgs e)
        {
            mouseDown = false;
        }
