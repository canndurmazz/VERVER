...
{
    public partial class uretimsifre : Form
    {
        ...
        {
            uretimyonetimsifre uretimyonetimsifre = new uretimyonetimsifre();
        ...
        private void uretimsifre_MouseDown(object sender, MouseEventArgs e)
        {
            mouseDown = true;
            lastLocation = e.Location;
        }

        private void uretimsifre_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            {
        ...
        private void uretimsifre_MouseUp(object sender, MouseEventArgs e)
        {
