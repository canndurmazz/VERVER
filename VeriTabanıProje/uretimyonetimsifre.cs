...
{
    public partial class uretimyonetimsifre : Form
    {
            ...
            else
            {
                try
                {
                    SqlCommand al = new SqlCommand("Select kullanici_ad,kullanici_sifre from kullanicilar where yetki_id=(select yetki_id from yetki where yetki_ad='Yönetici') and kullanici_id in" +
                        " (select personel_id from personel where departman_id=(select departman_id from departman where departman_ad='Üretim ve Planlama'))", baglanti);
        ...
        private void uretimyonetimsifre_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void uretimyonetimsifre_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            {
        ...
        private void uretimyonetimsifre_MouseUp(object sender, MouseEventArgs e)
        {
