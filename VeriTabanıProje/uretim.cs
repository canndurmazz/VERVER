...
namespace VeriTabanıProje
{
    public partial class uretim : Form
    {
        ...
        private void textgerekliham_TextChanged(object sender, EventArgs e)
        {

        }

        private void labelgerekliham_Click(object sender, EventArgs e)
        {

        }

        private void texttoplamham_TextChanged(object sender, EventArgs e)
        {
        ...
        private void texthammadde_TextChanged(object sender, EventArgs e)
        {
        ...
        private void uretim_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void uretim_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            {
        ...
        private void uretim_MouseUp(object sender, MouseEventArgs e)
        {
            mouseDown = false;
        }
    }
