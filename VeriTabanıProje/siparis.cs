...
namespace VeriTabanıProje
{
    public partial class siparis : Form
    {
        ...
        private void siparis_MouseDown(object sender, MouseEventArgs e)
        {
            mouseDown = true;
            lastLocation = e.Location;
        }

        private void siparis_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            {
        ...
        private void siparis_MouseUp(object sender, MouseEventArgs e)
        {
            mouseDown = false;
        }
    }
