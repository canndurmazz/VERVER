...
namespace VeriTabanıProje
{
    public partial class satinyoneticisifre : Form
    {
        ...
        private void satinyoneticisifre_MouseDown(object sender, MouseEventArgs e)
        {
            mouseDown = true;
            lastLocation = e.Location;
        }

        private void satinyoneticisifre_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            {
        ...
        private void satinyoneticisifre_MouseUp(object sender, MouseEventArgs e)
        {
