...
namespace VeriTabanıProje
{
    public partial class ikyoneticimenu : Form
    {
        ...
        private void ikyoneticimenu_MouseDown(object sender, MouseEventArgs e)
        {
            mouseDown = true;
            lastLocation = e.Location;
        }

        private void ikyoneticimenu_MouseMove(object sender, MouseEventArgs e)
        {
        ...
        private void ikyoneticimenu_MouseUp(object sender, MouseEventArgs e)
        {
            mouseDown = false;
        }
