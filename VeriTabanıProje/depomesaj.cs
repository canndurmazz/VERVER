...
namespace VeriTabanıProje
{
    public partial class depomesaj : Form
    {
        ...
        private void depomesaj_MouseDown(object sender, MouseEventArgs e)
        {
            mouseDown = true;
            lastLocation = e.Location;
        }

        private void depomesaj_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            {
        ...
        private void depomesaj_MouseUp(object sender, MouseEventArgs e)
        {
            mouseDown = false;
        }
    }
